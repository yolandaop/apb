        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    ?>
                    <?php echo form_open_multipart('buku/insert', array('class' => 'form-horizontal', 'id' => 'jvalidate', 'autocomplete'=>'off')) ?>

                        <div class="form-group">
                            <p class="col-sm-2 text-left">Kode Buku </p>

                            <div class="col-sm-10">
                                <input type="text" name="bibid" class="form-control" placeholder="Kode Buku" value="<?php echo set_value('bibid'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="deskripsi" class="form-control" placeholder="Deskripsi Buku" value="<?php echo set_value('deskripsi'); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nomor" class="form-control" placeholder="Nomor Buku" value="<?php echo set_value('nomor'); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="eksemplar" class="form-control" placeholder="Jumlah Buku" value="<?php echo set_value('eksemplar'); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="kepemilikan" class="form-control" placeholder="Sumber kepemilikan" value="<?php echo set_value('kepemilikan'); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="sumber" class="form-control" placeholder="Sumber buku" value="<?php echo set_value('sumber'); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="tanggal_diterima" class="form-control" placeholder="01-01-2000" value="<?php echo set_value('tanggal_diterima'); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="tanggal_digunakan" class="form-control" placeholder="01-01-2000" value="<?php echo set_value('tanggal_digunakan'); ?>">
                            </div>
                        </div>
