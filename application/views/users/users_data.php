...
<div class="row">
    <div class="col-lg-12"><br />
        ...
        <ol class="breadcrumb">
            <li><a href="<?php print_r base_url('users'); ?>">Users</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <?php print_r anchor('users/create', 'Add', array('class' => 'btn btn-primary btn-sm')); ?>
        <br /><br />
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php print_r $row->level;?></td>                               
                                        <td><?php print_r $row->password;?></td>
                                        <td class="text-center">
                                <a href="<?php print_r base_url('users/edit/'.$row->id) ?>"><input type="submit" class="btn btn-success btn-xs" name="edit" value="Edit"></a>
                                <a href="#"  class="hapus btn btn-danger btn-xs" 
                                username="<?php print_r $row->username;?>" 
                                kode="<?php print_r $row->id_petugas; ?>">Hapus</a>
                            </td>
                                    </tr>
                                <?php $no++; } ?>    
                                </tbody>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#konfirmasi").click(function(){
            ...
            $.ajax({
                url:"<?php print_r site_url('users/delete');?>",
                type:"POST",
                data:"id_petugas="+id_petugas,
                cache:false,
                success:function(html){
                    location.href="<?php print_r site_url('users/index/delete-success');?>";
                }
            });
        });
    });
